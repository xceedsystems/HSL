...
#define IDS_REMOTE_BASE               0                           /* We may want the base set to 0, 
                                                                                  to preserve the manufacturer's error codes */
                                                              
#define IDS_REMOTE_HW_TEST            ( IDS_REMOTE_BASE + 1 )   /* Hardware test failed                                  */
#define IDS_REMOTE_INVALID_ADDERSS    ( IDS_REMOTE_BASE + 2 )   /* Address is out of range                               */
#define IDS_REMOTE_DEVICE_OFFLINE     ( IDS_REMOTE_BASE + 3 )   /* Address points to an offline device                   */
#define IDS_REMOTE_TIMEOUT            ( IDS_REMOTE_BASE + 4 )   /* Timeout error for this function                       */
#define IDS_REMOTE_READ_SIZE          ( IDS_REMOTE_BASE + 5 )   /* Read  buffer too short                                */
#define IDS_REMOTE_WRITE_SIZE         ( IDS_REMOTE_BASE + 6 )   /* Write buffer too short                                */
#define IDS_REMOTE_RW_ZERO            ( IDS_REMOTE_BASE + 7 )   /* Zero bytes to be transferred                          */
#define IDS_REMOTE_DPR_OUT            ( IDS_REMOTE_BASE + 8 )   /* Out of DPR image                                      */


#define IDS_ERR_PCI_OUTOF_IOIMAGE			( IDS_REMOTE_BASE + 10 )
#define IDS_ERR_PCI_INVALID_REGSIZE			( IDS_REMOTE_BASE + 11 )
#define IDS_ERR_PCI_CANNOT_FIND_PCIDEVICE	( IDS_REMOTE_BASE + 12 )	/* Cannot find get PCI config data for Board Index '%3'.  '%4' boards found on the system. */
#define IDS_ERR_PCI_BOARD_NO_MISMATCH		( IDS_REMOTE_BASE + 13 )	/* Board count mismatch. Expected '%3',  found '%4'. */
